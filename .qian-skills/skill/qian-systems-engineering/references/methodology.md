...
| 原则 | 软件工程落点 | 最小证据 |
| --- | --- | --- |
| 总体设计 | 总体设计基线、目标树、子系统边界 | project-specific top-level design |
...
完整、规范性的条款位于
[钱学森 Skills 约束](constraints.md)。以下为不可豁免的核心：
...
9. 每次编码必须遵守 [Karpathy Coding Discipline](karpathy-guidelines.md)；
